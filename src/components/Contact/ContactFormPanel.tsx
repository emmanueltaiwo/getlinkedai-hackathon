...
const ContactFormPanel = () => {
  return (
    <div className="xl:mr-[188px] z-20 lg:mr-[100px] md:mr-[50px] md:bg-[rgba(255,255,255,0.03)] rounded-[12px] md:shadow-md md:shadow-[rgba(0,0,0,0.25)] lg:w-[500px] xl:w-[617px] lg:h-[620px] md:h-[580px] xl:h-[611px] md:w-[450px] flex w-full h-fit p-3 justify-center items-center flex-col gap-5">
