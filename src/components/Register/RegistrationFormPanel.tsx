...
const RegistrationFormPanel = () => {
  return (
    <div className="xl:mr-[128px] z-[1000px] lg:mr-[100px] rounded-[12px] md:mt-10 lg:mt-0 md:bg-[rgba(255,255,255,0.03)] md:shadow-sm md:shadow-[rgba(0,0,0,0.25)] lg:w-[640px] xl:w-[740px] md:pb-10 md:h-fit md:w-[700px] flex w-full h-fit p-3 justify-center items-center gap-5">
