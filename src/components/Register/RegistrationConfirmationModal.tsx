  ...
  return (
    <>
      <div
        ...
        className="fixed top-0 left-0 right-0 bottom-0 w-full h-screen z-20 bg-[rgba(21,14,40,0.93)]"
      />
      <main
      ...
      >
        <section
          className="xl:w-[699px] absolute w-[85%] h-[80%] flex justify-center items-center flex-col gap-5 mx-auto left-0 right-0 top-0 bottom-0 z-50 rounded-[5px] my-auto xl:h-[620px] border-[1px] border-[#D434FE] shadow-sm shadow-[rgba(255,255,255,0.01)]"
          onClick={handleCloseModal}
        >
          <Image
